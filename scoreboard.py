...
class Scoreboard():
    ...
    def prep_score(self):
        """Turn the score in a rendered image."""
    ...
    def prep_high_score(self):
        ...
        self.high_score_image = self.font.render(high_score_str, True,
                                                 self.text_color,
                                                 self.settings.bg_color)
        # Center the high score at the centre of the screen
    ...
    def prep_level(self):
        """Turn the player level in a rendered image."""
    ...
    def prep_ships(self):
        """Show how many ships are left to the player."""
        self.ships = Group()
